...
\input{src/testkonzept.tex}
\input{src/testfaelle.tex}
\input{src/prototyp.tex}
\input{src/management.tex}
\input{src/fazit.tex}
\newpage
...
\input{src/anhang/vorher-nachher-vergleich.tex}
\input{src/anhang/test_konzept.tex}
\input{src/anhang/testfaelle.tex}
\input{src/anhang/prototyp_doc.tex}
\newpage
