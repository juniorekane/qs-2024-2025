...
\begin{center}
	\begin{talltblr}[caption={Testfälle für die Hausverwaltungssoftware}, label={tab:testcases}]{width=0.9\textwidth, colspec={X[1,l,m] X[3,c,m] X[3,l,m] X[3,l,m] X[3,l,m]}}\toprule
        ...
        TC-006 & Eingabe einer zu langen Zähler-ID & `123-2024-45678` (11 Zeichen) & Fehlermeldung: *„Zähler-ID muss genau 10 Zeichen haben.“* & Negative Test \\ \cmidrule{1-5}
        TC-007 & Filtern nach Gebäude und Zählertyp & Gebäude: `Haus A`, Zählertyp: `Strom` & Liste zeigt nur Stromzähler von `Haus A` & Integrationstest \\ \cmidrule{1-5}
