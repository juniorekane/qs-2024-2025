...
\subsubsection{Ableitung konkreter Testfällen}
...
\subsection{Testfälle Dokumentation}

Die Tests, die wir oben aufgeführt haben, wurden in einer strukturierten Flask-Umgebung mit pytest automatisiert ausgeführt.
Um die Nachvollziehbarkeit zu gewährleisten, wurden alle Testergebnisse in einem Testprotokoll dokumentiert. Die Testergebnissse zeigen, dass der Prototyp die definiertenn Anforderungen erfüllt, wobei
vor allem Performance-Tests dazu beitragen, die Skalierbarkeit des Systems zu bewerten.